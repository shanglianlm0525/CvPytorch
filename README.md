...
- [2022.09.21] Release **YOLOX-PAI ** models with *yolox-pai-s* on [COCO](http://mscoco.org/) (**41.06mAP**), refer to [conf/coco_pai_yolox_s.yml](conf/coco_pai_yolox_s.yml).
...
- [2022.05.31] Release **YOLOv5** models with *yolov5-s* on [COCO](http://mscoco.org/) (**36.10mAP**), refer to [conf/coco_yolov5_s.yml](conf/coco_yolov5_s.yml).
