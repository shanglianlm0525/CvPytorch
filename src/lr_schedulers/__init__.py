...
from .warmup_lr_scheduler import WarmupStepLR, WarmupMultiStepLR, WarmupExponentialLR, WarmupReduceLROnPlateau, WarmupCosineAnnealingLR

__all__ = ['StepLR', 'MultiStepLR', 'ReduceLROnPlateau','CosineAnnealingLR'
    ,'WarmupStepLR','WarmupMultiStepLR','WarmupReduceLROnPlateau','WarmupCosineAnnealingLR']
...
def build_lr_scheduler(cfg, optimizer):
    if cfg.WARMUP.NAME is not None:
        ...
        if cfg.LR_SCHEDULER.TYPE == "MultiStepLR":
            ...
            lr_scheduler_ft = WarmupReduceLROnPlateau(
                optimizer, factor=cfg.LR_SCHEDULER.GAMMA or 0.1, patience=cfg.LR_SCHEDULER.STEP, cfg=cfg
            )
        elif cfg.LR_SCHEDULER.TYPE == "CosineAnnealingLR":
