...
if __name__ == '__main__':
    ...
    # parser.add_argument('--setting', default='conf/seg/regseg/cityscapes_regseg.yml', help='The path to the configuration file.')
    parser.add_argument('--setting', default='conf/seg/segnext/cityscapes_segnext_s.yml', help='The path to the configuration file.')
