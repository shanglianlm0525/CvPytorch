...
if __name__=="__main__":
    ...
    dataset=COCODataset("/home/lmin/data/coco/images/train2017","/home/lmin/data/coco/annotations/instances_train2017.json")
    # img,boxes,classes=dataset[0]
    # print(boxes,classes,"\n",img.shape,boxes.shape,classes.shape,boxes.dtype,classes.dtype,img.dtype)
    # cv2.imwrite("./123.jpg",img)
    img,boxes,classes=dataset.collate_fn([dataset[0],dataset[1]])
    # print(boxes,classes,"\n",img.shape,boxes.shape,classes.shape,boxes.dtype,classes.dtype,img.dtype)
    print(img.shape, img, boxes.shape, boxes, classes.shape, classes)
